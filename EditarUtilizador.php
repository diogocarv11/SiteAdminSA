        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <!-- codigo para editar/eliminar users -->
                    <form method="POST">

                        <input class="form-control" name="txtIdUser" value="<?php echo $UserEditar["idUser"]; ?>" type="hidden"/>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <input class="form-control" id="inputNomeUser" name="txtNomeUser" value="<?php echo $UserEditar["NomeUser"]; ?>" type="text" placeholder="Nome" required/>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <input class="form-control" id="inputEmailUser" name="txtEmailUser" value="<?php echo $UserEditar["EmailUser"]; ?>" type="email" placeholder="Email" required/>
                            ...
                            <div class="form-floating mb-3">
                                    ...
                                    <input class="form-control" id="inputPasswordUser" name="txtPasswordUser" value="<?php echo $UserEditar["PasswordUser"]; ?>" type="password" placeholder="PasswordUser" required/>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <input class="form-control" id="inputNrTelemovelUser" name="nrTelemovelUser" value="<?php echo $UserEditar["TelemovelUser"]; ?>" type="text" placeholder="TelemóvelUser" required/>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <Select class="form-control" id="inputTipo" name="Tipo" value="<?php echo $UserEditar["Tipo"]; ?>" type="text" placeholder="Tipo" required>
