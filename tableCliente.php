                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Tabela Clientes</li>
                        </ol>
                        <div class="btn-newCliente">
                            <a class="btn btn-primary" href="CriarCliente.php" role="button">Criar novo cliente</a>
                        </div>
                        <br>
                        <div class="card mb-4">
                                    ...
                                    <tbody>
                                        <?php foreach ($Clientes as $Cliente) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $Cliente["NIFCliente"]; ?></td>
                                                <td><?php echo $Cliente["TelemovelCliente"]; ?></td>
                                                <td><?php echo $Cliente["EmailCliente"]; ?></td>
                                                <td><?php echo $Cliente["Morada"]; ?></td>
                                                <td><?php echo $Cliente["Localidade"]; ?></td>
                                                <td><?php echo $Cliente["CodigoPostal"]; ?></td>
                            
                                                <td>
                                                    <a href="EditarCliente.php?idCliente=<?php echo $Cliente["idCliente"]; ?>">
                                                        Editar
                                                    </a>
                                                </td>
                                                <td>
                                                    <a href="tableCliente.php?action=apagar&idCliente=<?php echo $Cliente["idCliente"]; ?>">
                                                        Eliminar
                                                    </a>
                                                </td>
                                            </tr>
