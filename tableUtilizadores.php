                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Tabela Utilizadores</li>
                        </ol>
                        <div class="btn-newUser">
                            <a class="btn btn-primary" href="CriarUtilizador.php" role="button">Criar novo utilizador</a>
                        </div>
                        <br>
                        <div class="card mb-4">
                                    ...
                                    <tbody>
                                        <?php foreach ($Users as $User) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $User["TelemovelUser"]; ?></td>
                                                <td><?php echo $User["Tipo"]; ?></td>

                                                <td>
                                                    <a href="EditarUtilizador.php?idUser=<?php echo $User["idUser"]; ?>">
                                                        Editar
                                                    </a>
                                                </td>
                                                <td>
                                                    <a href="tableUtilizadores.php?action=apagar&idUser=<?php echo $User["idUser"]; ?>">
                                                        Eliminar
                                                    </a>
                                                </td>
                                            </tr>
