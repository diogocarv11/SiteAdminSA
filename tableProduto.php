...
if (isset($_GET["action"])){
    ...
    if ($_GET["action"] == "apagar"){
        ...
        $imagename = $_GET["Imagem"];

        unlink("img-produtos/" . $imagename);
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Tabela Produtos</li>
                        </ol>
                        <div class="btn-newProduto">
                            <a class="btn btn-primary" href="CriarProduto.php" role="button">Criar novo produto</a>
                        </div>
                        <br>
                        <div class="card mb-4">
                                    ...
                                    <tbody>
                                        <?php foreach ($Produtos as $Produto) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="img-produtos/<?php echo $Produto["Imagem"]; ?>" width="75"></td>
                                                <td><?php echo $Produto["Descricao"]; ?></td>

                                                <td>
                                                    <a href="EditarProduto.php?idProduto=<?php echo $Produto["idProduto"]; ?>">
                                                        Editar
                                                    </a>
                                                </td>
                                                <td>
                                                    <a href="tableProduto.php?action=apagar&idProduto=<?php echo $Produto["idProduto"]; ?>&Imagem=<?php echo $Produto["Imagem"]; ?>">
                                                        Eliminar
                                                    </a>
                                                </td>
                                            </tr>
