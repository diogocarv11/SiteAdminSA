            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Criar novo cliente</h1>
                        ...
                        <form method="POST">
                            <div class="card-body">
                                ...
                                <div class="form-floating mb-0">
                                    ...
                                    <input class="form-control" id="inputNomeCliente" name="txtNomeCliente" type="text" placeholder="NomeCliente" required/>
                                ...
                                <div class="form-floating mb-0">
                                    ...
                                    <input class="form-control" id="inputNIFCliente" name="nrNIFCliente" type="text" placeholder="NIFCliente" width="35%" required/>
                                ...
                                <div class="form-floating mb-0">
                                    ...
                                    <input class="form-control" id="inputNrTelemovelCliente" name="nrTelemovelCliente" type="text" placeholder="Telemóvel" required/>
                                ...
                                <div class="form-floating mb-0">
                                    ...
                                    <input class="form-control" id="inputEmailCliente" name="txtEmailCliente" type="email" placeholder="emailCliente" required/>
                                ...
                                <div class="form-floating mb-0">
                                    ...
                                    <input class="form-control" id="inputMorada" name="txtMorada" type="text" placeholder="Morada" required/>
                                ...
                                <div class="form-floating mb-0">
                                    ...
                                    <input class="form-control" id="inputLocalidade" name="txtLocalidade" type="text" placeholder="Localidade" required/>
                                ...
                                <div class="form-floating mb-0">
                                    ...
                                    <input class="form-control" id="inputCodigoPostal" name="nrCodigoPostal" type="text" placeholder="CodigoPostal" required/>
                                    <label for="inputCodigoPostal">Código Postal</label>
                                    <br>

                                </div>
                                <input class="btn btn-primary" type="submit" name="btnCriar" value ="Criar" style="float: right;" />
                            </div>
                        </form>
                    </div>
                </main>
