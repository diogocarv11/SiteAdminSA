...
include_once "News.php";
    ...
    if (isset($_GET["idNews"])){
        ...
        $NewsEditar = $News->getById()[0];
    }

//Identificar que o botão foi clicado
if (isset($_POST["btnGravarEdicao"])){

    $idNews = $_POST["txtIdNews"];
    $ImagemNews = $_POST["ImagemNews"];
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Editar Novidades</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="tableNews.php">Novidades e Notícias</a></li>
                            <li class="breadcrumb-item active">Editar Novidades e Notícias</li>
                        </ol>
                        <br>
                    </div>
                    ...
                    <input class="form-control" name="txtIdNews" value="<?php echo $NewsEditar["idNews"]; ?>" type="hidden"/>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <label for="formFile" class="form-label">Escolha a imagem da novidade</label>
                                <input class="form-control form-control" name="ImagemNews" value="<?php echo $NewsEditar["ImagemNews"]; ?>" id="formFile" type="file" style="padding: 16px 12px;" required/>
                                <br>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <input class="form-control" id="inputDescricaoNews" name="txtDescricaoNews" value="<?php echo $NewsEditar["DescricaoNews"]; ?>" type="text" placeholder="DescricaoNews" required/>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <input class="form-control" id="inputLinkNews" name="txtLinkNews" value="<?php echo $NewsEditar["LinkNews"]; ?>" type="text" placeholder="Link" required/>
